...
//================This is split line================
// KEYWORD: COMPONENT NAME IS  Experiment15

// description:HelloWorld
#define AOS_APP_EXPERIMENT15 1

// #if AOS_APP_EXPERIMENT15
...
// description:CAN NOT BE MODIFIED
#define AOS_BUILD_APP "Experiment15"
...
// #if (((ULOG_CONFIG_POP_FS) || (ULOG_CONFIG_UPLOAD || ULOG_CONFIG_POP_CLOUD)) || y)
...
// #if ((((ULOG_CONFIG_UPLOAD || ULOG_CONFIG_POP_CLOUD) && USE_ITLS) || (((ULOG_CONFIG_UPLOAD || ULOG_CONFIG_POP_CLOUD) && ENABLE_DYNAMIC_REGISTER) && USE_ITLS)) || y)
